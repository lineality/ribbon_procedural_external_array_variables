//! # Procedural External Hex ContinCascade Counter
//! - uses heap
//! - u32 is too big to start with
//! - hex output is awkward
//!
//! A tiered stack-based hexadecimal counter that uses cascading buffers
//! for memory efficiency while maintaining stack allocation benefits.
//!
//! ## Architecture (POC, not sensible)
